...
class AuthEventCallbackStub : public IRemoteStub<IAuthEventCallback>, public NoCopyable {
public:
    AuthEventCallbackStub() = default;
    ~AuthEventCallbackStub() override = default;
