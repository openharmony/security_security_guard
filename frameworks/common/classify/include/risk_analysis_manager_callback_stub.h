...
#ifndef SECURITY_GUARD_RISK_ANALYSIS_MANAGER_CALBACK_STUB_H
#define SECURITY_GUARD_RISK_ANALYSIS_MANAGER_CALBACK_STUB_H
...
#endif // SECURITY_GUARD_RISK_ANALYSIS_MANAGER_CALBACK_STUB_H
