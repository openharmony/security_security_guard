...
public:
    ...
    virtual ~UeventListenerImpl() = default;
    virtual bool InitUevent() { return true; };
    virtual int UeventListen(char *buffer, size_t length) { return 0; };
    virtual void ParseEvent(char *buffer, size_t length) { return; };
};
} // namespace OHOS::Security::SecurityGuard
