...
private:
    bool GetSecEvent(std::shared_ptr<HiviewDFX::HiSysEventRecord> sysEvent, SecEvent& event) { return false; };
    void filterInstallOrUpdateContent(int64_t eventId, nlohmann::json& jsonObj) {};
    bool filterHashValue(nlohmann::json& jsonObj) { return false; };
};
