...
public:
    ...
    virtual bool SetMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag);
    virtual bool SetUnMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag);
private:
