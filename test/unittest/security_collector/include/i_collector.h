...
public:
    ...
    virtual int SetMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag) {return 0;};
    virtual int SetUnMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag) {return 0;};
};
} // namespace OHOS::Security::SecurityCollector
