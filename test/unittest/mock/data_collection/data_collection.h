...
public:
    ...
    virtual bool SubscribeCollectorsBySticky(const std::vector<int64_t> &eventIds,
...
public:
    ...
    MOCK_METHOD2(SubscribeCollectorsBySticky, bool(const std::vector<int64_t>& eventIds,
