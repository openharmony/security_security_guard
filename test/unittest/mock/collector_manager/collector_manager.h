...
public:
    ...
    MOCK_METHOD2(AddFilter, int32_t(const SecurityCollectorEventFilter &subscribeMute,
        const std::string &callbackFlag));
    MOCK_METHOD2(RemoveFilter, int32_t(const SecurityCollectorEventFilter &subscribeMute,
        const std::string &callbackFlag));
};
