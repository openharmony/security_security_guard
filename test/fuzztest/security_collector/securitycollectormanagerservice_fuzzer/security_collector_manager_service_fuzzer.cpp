...
#include "security_collector_manager_service_fuzzer.h"
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    // Wait for all async tasks submitted by this iteration (e.g.
    // SecurityCollectorRunManager::CollectorListenner::OnNotify) to finish before
    // the process exits, otherwise they may touch destroyed singletons during
    // teardown and report use-after-free.
    ffrt::wait();
    return 0;
}
