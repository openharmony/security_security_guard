...
public:
    ...
    void CloseLib();
    bool SetMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag);
    bool SetUnMute(const SecurityCollectorEventMuteFilter &filter, const std::string &sdkFlag);
private:
