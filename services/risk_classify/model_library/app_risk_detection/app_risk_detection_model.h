...
#ifndef SECURITY_GUARD_APP_RISK_DETECTION_MODEL_H
#define SECURITY_GUARD_APP_RISK_DETECTION_MODEL_H
...
class AppRiskDetectionModel : public IModel {
public:
    ~AppRiskDetectionModel() override;
...
#endif // SECURITY_GUARD_APP_RISK_DETECTION_MODEL_H