...
#ifndef SECURITY_GUARD_ROOT_SCAN_MODEL_H
#define SECURITY_GUARD_ROOT_SCAN_MODEL_H
...
class RootScanModel : public IModel {
public:
    ~RootScanModel() override;
...
#endif // SECURITY_GUARD_ROOT_SCAN_MODEL_H