...
#ifndef SECURITY_GUARD_PHYSICAL_MACHINE_DETECTION_MODEL_H
#define SECURITY_GUARD_PHYSICAL_MACHINE_DETECTION_MODEL_H
...
class PhysicalMachineDetectionModel : public IModel {
public:
    ~PhysicalMachineDetectionModel() override;
...
#endif // SECURITY_GUARD_PHYSICAL_MACHINE_DETECTION_MODEL_H